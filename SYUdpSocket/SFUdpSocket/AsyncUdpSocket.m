...
- (id)initWithDelegate:(id)delegate isIpv6:(BOOL)isIpv6
{
    return [self initWithDelegate:delegate userData:0 enableIPv4:!isIpv6 enableIPv6:isIpv6];
}

- (id)initWithDelegate:(id)delegate
{
	return [self initWithDelegate:delegate userData:0 enableIPv4:NO enableIPv6:YES];
}
...
{
    int reuseOn=1;
     setsockopt(CFSocketGetNative(theSocket4), SOL_SOCKET, SO_NOSIGPIPE, &reuseOn, sizeof(reuseOn));
}
